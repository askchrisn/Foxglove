...
} from "../panels/ThreeDeeRender/renderables/colorMode";
import { FieldReader, getReader, isSupportedField } from "../panels/ThreeDeeRender/renderables/pointClouds/fieldReaders";
...
import { POINTCLOUD_DATATYPES as FOXGLOVE_POINTCLOUD_DATATYPES } from "../panels/ThreeDeeRender/foxglove";
import {
  normalizeByteArray,
  normalizeHeader,
  normalizeTime,
...
export class PointClouds extends SceneExtension<PointCloudHistoryRenderable> {
  ...
  public lastRecievedPointCloud: PointCloud | PointCloud2 = {
  ...
  #handleRosPointCloud = (messageEvent: PartialMessageEvent<PointCloud2>): void => {
    ...
    this.latestPointCloud = pointCloud;
  ...
  #handleGridCells = (messageEvent: PartialMessageEvent<GridCells>): void => {
    ...
    renderable.updateGridCells(gridCells, latestOriginalMessage, new PointCloud, settings, receiveTime);
...
export class GridCellsScene extends SceneExtension<PointCloudHistoryRenderable> {
  public static extensionId = "foxglove.PointClouds";
  #fieldsByTopic = new Map<string, string[]>();
